import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, getCurrentInstance, inject, defineComponent, defineAsyncComponent, h, computed, unref, shallowRef, provide, shallowReactive, useSSRContext, createApp, reactive, mergeProps, withCtx, createVNode, toRef, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, effectScope, isReadonly, isRef, isShallow, isReactive, toRaw, Suspense, nextTick, getCurrentScope } from 'vue';
import { j as hasProtocol, k as isScriptProtocol, l as joinURL, w as withQuery, s as sanitizeStatusCode, m as getContext, $ as $fetch, n as baseURL, o as createHooks, e as createError$1, q as isEqual, r as stringifyParsedURL, t as stringifyQuery, v as parseQuery, x as toRouteMatcher, y as createRouter, z as defu } from '../nitro/nitro.mjs';
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-CwDyL0JA.mjs').then((m) => m.default || m))
};
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_Body, mergeProps({ class: "body" }, _attrs), {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Be5rjY3E.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BCRcnJ3-.mjs'));
...
export { useRouter as a, useNuxtApp as b, useRuntimeConfig as c, nuxtLinkDefaults as d, entry_default as default, navigateTo as n, resolveRouteObject as r, useHead as u };
